...
describe('user model functions', () => {
	describe('create  user(s)', () => {
		...
		it('[4] user1 inserted username and password', async () => {
		...
		it('[5] user2 inserted username and password', async () => {
		...
		it('[6] user3 inserted username and password', async () => {
